...
echo "Phase 9.5ad TC consumer passed: policy-first final-tuple selection, dual-stack late binding, flow-stable leases, verifier loading, and Required fail-closed behavior"
