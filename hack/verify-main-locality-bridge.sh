...
printf 'main-locality-suite: PASS tests=7 compiled-source=true actual-main=true missing-bank-fallback=true reverse-service-policy=true live-attachment=false bank-delivery=false\n'
