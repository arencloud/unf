...
cleanup() {
    ...
    if [[ $suite == kernel-delivery || $suite == kernel-admission || $suite == kernel-journal-floor ]]; then
    ...
    if [[ $suite == kernel-admission || $suite == kernel-journal-floor ]]; then
    ...
    if [[ $suite == kernel-journal-floor ]]; then
