...
rg --fixed-strings --quiet \
    'pub const PERSISTENT_BPF_STATE_ABI_VERSION: u16 = 12;' \
...
echo "Phase 8.5 egress map transaction passed: ABI-v12 ownership, readback, capacity rollback, and pointer recovery are exact"
