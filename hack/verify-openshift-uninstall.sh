...
[[ $(grep -c 'remove map pin: /sys/fs/bpf/unf/v13/' \
    "${temporary_dir}/plan.txt") -eq $((agent_count * 33)) ]]
[[ $(grep -c 'remove map pin: /sys/fs/bpf/unf/v12/' \
    "${temporary_dir}/plan.txt") -eq $((agent_count * 31)) ]]
[[ $(grep -c 'remove map pin: /sys/fs/bpf/unf/v11/' \
    "${temporary_dir}/plan.txt") -eq $((agent_count * 25)) ]]
[[ $(grep -c 'remove map pin: /sys/fs/bpf/unf/v10/' \
    "${temporary_dir}/plan.txt") -eq $((agent_count * 25)) ]]
[[ $(grep -c 'remove map pin: /sys/fs/bpf/unf/v9/' \
    "${temporary_dir}/plan.txt") -eq $((agent_count * 25)) ]]
[[ $(grep -c 'remove map pin: /sys/fs/bpf/unf/v8/' \
    "${temporary_dir}/plan.txt") -eq $((agent_count * 24)) ]]
[[ $(grep -c 'remove map pin: /sys/fs/bpf/unf/v7/' \
    "${temporary_dir}/plan.txt") -eq $((agent_count * 24)) ]]
