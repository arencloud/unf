...
Complete milestone 9.5 by composing the new bounded TC consumer with
Service/egress/DSR selection and passing restart, rotation, revocation,
IPv4/IPv6, and live-kernel ciphertext gates. The compiler/ABI, transaction contract, isolated
