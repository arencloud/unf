...
Complete milestone 9.5 by distributing and durably adopting the 9.5q manifold
through the authenticated agent boundary, then feeding the Node-local compiler
...
and the causally sealed input manifold now pass their focused gates, but no
