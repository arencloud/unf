...
Complete milestone 9.5 by invoking bounded lookup after policy plus
Service/egress selection in TC from the 9.5ac locally compiled generation; and pass
