...
transaction boundary; invoke bounded lookup after policy plus Service/egress
selection in TC; preserve unrelated skb mark bits while selecting the exact
WireGuard policy route; and pass verifier, restart, rotation, revocation,
...
mirror now pass their focused gates, but no workload packet-path activation is
claimed yet. Live two-ended encrypted challenge proof remains milestone 9.6.
