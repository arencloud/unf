...
Complete milestone 9.5 by consuming the 9.5ab controller-published plan through
the Node-local compiler and exact exchange/activation/restart path; invoke
bounded lookup after policy plus Service/egress selection in TC; and pass
