...
Complete milestone 9.5 by adding address-exact replica binding, projecting Kubernetes facts into the 9.5x
...
durable edge-key bootstrap, reciprocal key witness matrix, demand-sparse fleet plan forge, and policy-truth quotient now pass their focused gates, but no workload
