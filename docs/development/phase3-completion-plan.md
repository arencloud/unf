...
| 6.3 | IPAM | **In progress** | The routing-independent node-block provider and lease core are verified; schema-v2 durable attachment integration, configuration provenance, and restart/release migration remain |
