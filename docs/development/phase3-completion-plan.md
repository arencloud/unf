...
| 6.6 | Node-to-node networking | **In progress** | Distribution, native lifecycle, durable reconciliation, and isolated dual-stack Kind primary-CNI operation are Verified; OpenShift-specific installation and cl02 RHCOS/SELinux qualification remain 6.6e |
...
| 6.6e | OpenShift primary-CNI design and qualification | **Planned** | Accept an OpenShift Network Operator/MachineConfig installation and recovery design before any CNI replacement, then qualify the bounded design on cl02 across dual-stack RHCOS workers under SELinux; Kind success does not authorize an in-place cl02 takeover |
