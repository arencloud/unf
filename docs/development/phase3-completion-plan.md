...
| 6.6 | Node-to-node networking | **In progress** | Controller-to-agent node-block/route distribution, provider-neutral native lifecycle, and durable runtime reconciliation/recovery are Verified; isolated primary-CNI installation and coexistence qualification remain |
