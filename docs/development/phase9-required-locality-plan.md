...
| Full authenticated controller and real reconciliation loops | Operator approved cl02 lab SYS_ADMIN (ADR 0448), resolving ADR 0445's permission decision. Exact non-privileged profile qualification and production-SCC admission remain required before rollout. Fixture-provided placement/privileged diagnostics are not restricted-runtime proof |
