...
| 8.6 | Deterministic HA, failover, and multiple addresses | **In progress** | The verified 8.6a–8.6d slices cover planning, promotion and continuity protocols, durable exclusive ownership, and proof/dataplane alignment; transactional live promotion, failure/drain recovery, and measured disruption remain |
...
Milestone 8.6e now connects the proof-carrying promotion coordinator and
Acknowledged Flow Twins to watched controller/agent transport. Sources must
fence, the former owner must revoke or be independently isolated, replacements
must acquire and import acknowledged pairs, and reachability must complete its
CAS before one complete source bank activates. Measured failure, drain,
recovery, and disruption remain the final 8.6 gate.
