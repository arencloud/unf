...
Milestone 8.11 now takes the exact committed Phase 8 runtime through an
independent digest-pinned five-Node dual-stack OpenShift cl02 gate. It must
verify RHCOS/SELinux/CRI-O operation, cross-worker source steering and NAT,
multi-address HA and recovery, temporal/reachability evidence, causal
operations, exact cleanup, five-agent convergence, and unchanged
ClusterOperator health relative to the captured baseline.
