...
| 8.10 | Kube-proxy-free Kind qualification | **Verified** | Runtime and qualifier `7c57664` passed the uninterrupted 1,008-second three-Node dual-stack Kubernetes v1.35.0 gate. Six digest-bound components cover watched policy/allocation/steering/NAT, measured HA, FQDN and Internet authority, DQR/native reachability, causal operations, restart recovery, proof-authorized interface-absence release, exact cleanup, and no-CNI rollback. Aggregate SHA-256 `feccddf02115da33e673f108ade153e17e530e24bad9233659efe8cd598c8209`; ADR 0156 |
