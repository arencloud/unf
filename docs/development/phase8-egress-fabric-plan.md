...
| 8.8 | Reachability and advertisement providers | **In progress** | 8.8a–8.8d verify provider-neutral Diversity-Quorum Reachability, authenticated durable observers, the native lifecycle, and causal-constrained dual-stack BGP convergence. BFD correlation and platform qualification remain |
