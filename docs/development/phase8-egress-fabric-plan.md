...
| 8.6 | Deterministic HA, failover, and multiple addresses | **In progress** | The verified 8.6a–8.6e slices cover planning, promotion/continuity protocols, durable exclusive ownership, proof/dataplane alignment, and restart-safe ordered transaction state; authenticated live transport, failure/drain recovery, and measured disruption remain |
...
Milestone 8.6f now connects the proof-carrying promotion coordinator and
