...
| 8.7 | FQDN and internet-access controls | **In progress** | 8.7a–8.7c verify temporal evidence, durable ownership, exact-name DNS production, transactional PLR materialization, and autonomous packet expiry. Wildcard/custom-view observation, a live multi-Node DNS lifecycle, internet classification/fallback, explanation/simulation/operations, and platform qualification remain |
