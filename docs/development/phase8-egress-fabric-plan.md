...
Milestone 8.8 begins provider-neutral reachability and advertisement. Static
development reachability remains the reference semantics; replaceable BGP
support must keep route policy, ECMP, graceful restart, BFD, ownership, and
readback authority explicit and independently testable. Operations, scale, and
platform qualification remain in milestones 8.9–8.11.
