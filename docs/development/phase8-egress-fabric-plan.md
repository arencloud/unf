...
| 8.6 | Deterministic HA, failover, and multiple addresses | **In progress** | The verified 8.6a planner, 8.6b promotion protocol, and 8.6c Acknowledged Flow Twin continuity protocol are complete; watched live integration, failure/drain recovery, and measured disruption remain |
...
Milestone 8.6d now connects CCR, proof-carrying promotion, and Acknowledged Flow
Twins to watched controller/agent state. Gateway address projections must carry
exclusive shard ownership instead of the former all-candidate lease set; the
standby must read back imported pairs before one complete source bank activates.
Measured failure, drain, recovery, and disruption remain the final 8.6 gate.
