...
| 8.10 | Kube-proxy-free Kind qualification | **Verified** | Runtime `99adfd6` qualified by `db263a1` passed the uninterrupted 1,015-second three-Node dual-stack Kubernetes v1.35.0 gate. Six digest-bound components cover watched policy/allocation/steering/NAT, measured HA, FQDN and Internet authority, DQR/native reachability, causal operations, restart recovery, exact cleanup, and no-CNI rollback. Aggregate SHA-256 `4cb13c79632ae661cad7b8d588b1fdac757ef7740199c68800a0b2666a060c15`; ADR 0156 |
