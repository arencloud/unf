...
| 8.6 | Deterministic HA, failover, and multiple addresses | **In progress** | The verified 8.6a planner and 8.6b proof-carrying promotion protocol are complete; established-flow continuity, watched live integration, failure/drain recovery, and measured disruption remain |
...
Milestone 8.6c now defines established-flow continuity and atomic complete-table
activation on top of the verified CCR planner and promotion authority. New
flows may switch to the certified contingency only as one bank transition;
existing flows need a bounded, lease- and tuple-bound continuity mechanism that
cannot resurrect expired state or permit both gateways to translate the same
tuple. Measured live failover remains a later 8.6 gate.
