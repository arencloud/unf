...
per-interface TCX links pinned below `/sys/fs/bpf/unf/v11/links` so a replacement
...
Removing current v11 state is an uninstall or controlled-reset operation. First
