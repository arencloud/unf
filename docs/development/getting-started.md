...
per-interface TCX links pinned below `/sys/fs/bpf/unf/v10/links` so a replacement
...
Removing current v10 state is an uninstall or controlled-reset operation. First
