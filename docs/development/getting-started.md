...
per-interface TCX links pinned below `/sys/fs/bpf/unf/v12/links` so a replacement
...
Removing current v12 state is an uninstall or controlled-reset operation. First
