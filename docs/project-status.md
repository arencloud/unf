...
- Agent acknowledgements are freshness-aware, controller-aggregated, and use a
  ...
  only. OpenShift Service CA integration and encrypted IPv4/IPv6 flow export
  are live-verified. Certificate hot reload/rotation, durable retention, and
  NetworkPolicy isolation remain.
