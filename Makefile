.PHONY: egress-fabric-boundary-test egress-intent-test egress-contract-test service-selection-boundary-test service-selection-ir-test service-selection-contract-test service-selection-state-test service-selection-dataplane-test service-affinity-dataplane-test service-maglev-dataplane-test service-dsr-dataplane-test service-selection-operations-test service-selection-kind-up service-selection-kind-load service-selection-kind-deploy service-selection-kind-test service-selection-kind-down service-selection-openshift-deploy service-selection-openshift-test
