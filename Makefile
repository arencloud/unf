.PHONY: egress-fabric-boundary-test egress-intent-test egress-contract-test egress-allocation-test egress-host-state-test egress-proof-test egress-dataplane-contract-test egress-dataplane-map-test egress-live-distribution-test egress-desired-state-test egress-gateway-distribution-test egress-control-plane-test egress-application-ack-test egress-source-steering-test egress-path-activation-test egress-gateway-address-test egress-gateway-nat-test egress-safe-forgetting-test service-selection-boundary-test service-selection-ir-test service-selection-contract-test service-selection-state-test service-selection-dataplane-test service-affinity-dataplane-test service-maglev-dataplane-test service-dsr-dataplane-test service-selection-operations-test service-selection-kind-up service-selection-kind-load service-selection-kind-deploy service-selection-kind-test service-selection-kind-down service-selection-openshift-deploy service-selection-openshift-test
